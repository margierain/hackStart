...
import Filter from 'template/views/ProjectList/Filter';
      ...
      <Container maxWidth="lg">
        ...
        <div className={classes.section}>
          <Card>
            <CardContent className={classes.content}>
              ...
              <Chip
                avatar={
                  <Avatar src="/template/images/avatars/avatar_3.png">
                    CM
                  </Avatar>
                }
              ...
              <Chip
                avatar={
                  <Avatar src="/template/images/avatars/avatar_5.png">
                    CM
                  </Avatar>
                }
                className={classes.chip}
        ...
        <div className={classes.section}>
          ...
          <Typography gutterBottom variant="subtitle2">
            ...
            <Link component={RouterLink} href="/projects">
              Project List View
            </Link>
          </Typography>
          <Filter />
