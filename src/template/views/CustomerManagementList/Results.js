...
import ReviewStars from 'template/components/ReviewStars';
import GenericMoreButton from 'template/components/GenericMoreButton';
import TableEditBar from 'template/components/TableEditBar';
...
function Results({ className = undefined, customers, ...rest }) {
