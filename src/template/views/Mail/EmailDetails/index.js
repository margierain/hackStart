...
function EmailDetails({ email, onEmailClose, className = undefined, ...rest }) {
    ...
    <div {...rest} className={clsx(classes.root, className)}>
      ...
      <div className={classes.header}>
        <div className={classes.receiver}>
          <Avatar className={classes.avatar} src={email.receiver.avatar}>
          ...
          <div>
            ...
            <Typography variant="subtitle2">
              To: <Link color="inherit">shen.zhi@devias.io</Link>,{' '}
      ...
      <div className={classes.content}>
        ...
        <Markdown className={classes.message} source={email.message} />
      </div>
      <Divider />
      <EmailForm />
    </div>
