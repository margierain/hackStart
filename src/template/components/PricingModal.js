...
function PricingModal({ open, onClose, className = undefined, ...rest }) {
            ...
            <Grid item md={4} xs={12}>
              ...
              >
                <img
                  ...
                  src="/template/images/products/product_freelancer.svg"
                />
            ...
            <Grid item md={4} xs={12}>
              ...
              >
                <img
                  alt="Product"
                  className={classes.image}
                  src="/template/images/products/product_agency--outlined.svg"
                />
                <Typography component="h3" gutterBottom variant="overline">
                  Agency
                </Typography>
            ...
            <Grid item md={4} xs={12}>
              ...
              >
                <img
                  alt="Product"
                  className={classes.image}
                  src="/template/images/products/product_enterprise.svg"
                />
                <Typography component="h3" gutterBottom variant="overline">
                  Enterprise
                </Typography>
